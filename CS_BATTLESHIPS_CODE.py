...
def get_tile_battleShipGame(baseConfigs, grid, givenCoordinates = None): # returns the tile that the mouse cursor is on as a tuple if given coordinates returns square for coordinates
